...
<script>
        ...
        if (appState.mode !== 'detail') {
            ...
            if (domCache.form.item.category) {
                ...
                domCache.form.item.category.addEventListener('change', (e) => {
                    ...
                    if (appState.mode === 'create') {
                        initializeDefaultDetails(parseInt(value));
                    }
                });
            }
    ...
    function initializeDefaultDetails(categoryID) {
        appState.details = [];
        if ([2, 3].includes(categoryID)) {
            appState.details = [{
                ...
                },
                {
                    id: 2,
                    no: '1.1',
                    description: 'Tampak Luar',
                    level: 2,
                    parent_id: 1,
                    status: "OK",
                    condition: "Tidak Butuh Perbaikan",
                    information: null,
                    is_show: 0,
                },
                {
